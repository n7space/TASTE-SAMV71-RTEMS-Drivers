...
typedef enum { pa10 = 0 } Serial_SamV71_Rtems_Device_T_uart0_tx;

// please use the following macros to avoid breaking code.
#define Serial_SamV71_Rtems_Device_T_uart0_tx_pa10 pa10
typedef enum { pa9 = 0 } Serial_SamV71_Rtems_Device_T_uart0_rx;
...
typedef enum { pa5 = 0 } Serial_SamV71_Rtems_Device_T_uart1_rx;
...
typedef enum { uart2_tx_pd26 = 0 } Serial_SamV71_Rtems_Device_T_uart2_tx;

// please use the following macros to avoid breaking code.
#define Serial_SamV71_Rtems_Device_T_uart2_tx_pd26 uart2_tx_pd26
typedef enum { pd25 = 0 } Serial_SamV71_Rtems_Device_T_uart2_rx;
...
typedef enum { pd30 = 0, pd31 = 1 } Serial_SamV71_Rtems_Device_T_uart3_tx;

// please use the following macros to avoid breaking code.
#define Serial_SamV71_Rtems_Device_T_uart3_tx_pd30 pd30
#define Serial_SamV71_Rtems_Device_T_uart3_tx_pd31 pd31
typedef enum { pd28 = 0 } Serial_SamV71_Rtems_Device_T_uart3_rx;
...
typedef enum { pd3 = 0, pd19 = 1 } Serial_SamV71_Rtems_Device_T_uart4_tx;

// please use the following macros to avoid breaking code.
#define Serial_SamV71_Rtems_Device_T_uart4_tx_pd3 pd3
#define Serial_SamV71_Rtems_Device_T_uart4_tx_pd19 pd19
typedef enum { pd18 = 0 } Serial_SamV71_Rtems_Device_T_uart4_rx;
...
#define ERR_SERIAL_SAMV71_RTEMS_BAUDRATE_T \
	261 /*b9600 | b19200 | b38400 | b57600 | b115200 | b230400*/
...
typedef enum { even = 0, odd = 1, none = 2 } Serial_SamV71_Rtems_Parity_T;
...
#define ERR_SERIAL_SAMV71_RTEMS_TRANSMIT_MODE_T \
	271 /*escaped-packets | raw-single-byte*/
