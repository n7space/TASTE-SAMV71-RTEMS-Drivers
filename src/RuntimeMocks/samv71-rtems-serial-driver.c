...
{
    flag ret = TRUE;
    ret = ((((((((((*(pVal)) == uart0)) || (((*(pVal)) == uart1)))) || (((*(pVal)) == uart2)))) || (((*(pVal)) == uart3)))) || (((*(pVal)) == uart4)));
...
{
    flag ret = TRUE;
    ret = ((((((((((((*(pVal)) == Serial_SamV71_Rtems_Baudrate_T_b9600)) || (((*(pVal)) == Serial_SamV71_Rtems_Baudrate_T_b19200)))) || (((*(pVal)) == Serial_SamV71_Rtems_Baudrate_T_b38400)))) || (((*(pVal)) == Serial_SamV71_Rtems_Baudrate_T_b57600)))) || (((*(pVal)) == Serial_SamV71_Rtems_Baudrate_T_b115200)))) || (((*(pVal)) == Serial_SamV71_Rtems_Baudrate_T_b230400)));
...
{
    flag ret = TRUE;
    ret = ((((((*(pVal)) == Serial_SamV71_Rtems_Parity_T_even)) || (((*(pVal)) == Serial_SamV71_Rtems_Parity_T_odd)))) || (((*(pVal)) == none)));
